...
export default function ThemeToggle() {
    ...
    return (
        <button
            ...
            className="w-10 h-10 flex items-center justify-center rounded-xl text-text-main dark:text-text-accent hover:bg-text-main/5 dark:hover:bg-white/10 transition-all active:scale-95"
