        ...
        <div className="min-h-screen bg-bg-cream dark:bg-brown-dark pb-32 md:pb-12 px-5 pt-8 transition-colors duration-300">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-6">
                    ...
                    <Link href="/settings" prefetch={false} className="p-2 text-tan-primary dark:text-tan-light hover:text-brown-dark dark:hover:text-text-accent transition-colors">
