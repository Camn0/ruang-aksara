            ...
            <div className="flex-1 flex flex-col items-center justify-center p text-center animate-in fade-in zoom-in duration-500">
                {step === 1 && (
                    <div className="relative w-full h-screen overflow-hidden flex items-center">
                        {/*xl = laptop  */}
                        <div className="
                            absolute top-1/2 -translate-y-1/2 -left-[35%] xl:-left-[20%] w-[90vw] xl:w-[75vw] aspect-square 
                            bg-[#f2ead7] rounded-full z-10 shadow-2xl">
                        </div>

                        {/* Left Side: The Cream Circle Area */}
                        <div className="relative z-10 w-full md:w-1/2 flex flex-col items-center justify-center p-8 text-center">
                            ...
                            <div className="text-center space-y-2 mb-10">
                                <h2 className="text-2xl md:text-4xl font-medium text-[#3b2a22]">Selamat Datang <br/>di</h2>
                                <h1 className="text-4xl md:text-6xl font-black text-[#3b2a22]">Ruang Aksara</h1>
                            </div>
                        ...
                        {/* Right Side: The Book Background */}
                        <div className="absolute right-0 top-0 w-full h-full z-0 ">
                            ...
                            />
                            {/* Subtle overlay to blend the books into the dark brown background */}
                        </div>
                    </div>
                )}

                {step === 2 && (
                    <div className="w-full max-w-2xl mt-16 px-6"> {/* Added margin top to make room for the floating image */}
