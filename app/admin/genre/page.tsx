    ...
    return (
        <div className="pb-24">
            ...
            <div className="px-6 pt-6 sm:pt-10 mb-6 sm:mb-10">
                <h1 className="text-2xl sm:text-4xl font-black text-brown-dark dark:text-gray-100 tracking-tight leading-none uppercase italic">Pengaturan Admin</h1>
            ...
            <div className="px-6">
                <div className="max-w-4xl bg-white/80 dark:bg-slate-900 backdrop-blur-sm rounded-3xl shadow-xl shadow-brown-dark/5 dark:shadow-none p-6 sm:p-10 border border-tan-primary/10 dark:border-slate-800 transition-colors duration-300">
                    ...
                    <div className="mb-8 border-t border-tan-primary/10 dark:border-slate-800 pt-10">
                        <h2 className="text-xl sm:text-2xl font-black text-brown-dark dark:text-gray-100 mb-6 flex items-center gap-3">
                    ...
                    <div className="mt-12">
                        ...
                        {genres.length === 0 ? (
                            <p className="text-brown-dark/50 dark:text-gray-400 italic font-bold">Belum ada genre yang ditambahkan.</p>
                        ) : (
                            <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                {genres.map(g => (
                                    <li key={g.id} className="bg-brown-dark/5 dark:bg-slate-800/50 border border-transparent dark:border-slate-800 rounded-2xl p-4 flex justify-between items-center transition-all hover:bg-white dark:hover:bg-slate-800 hover:shadow-lg hover:border-tan-primary/30 group">
