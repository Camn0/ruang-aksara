            ...
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-16">
                    ...
                    <div className="lg:row-span-2 bg-[#3B2A22] text-white p-4 md:p-10 rounded-[2rem] md:rounded-[3rem] shadow-2xl shadow-[#3B2A22]/20 flex flex-col justify-between group overflow-hidden relative min-h-[150px] md:min-h-[400px]">
                        <div className="relative z-10">
                            ...
                            <p className="text-[9px] md:text-[12px] font-black uppercase tracking-[0.2em] md:tracking-[0.3em] opacity-60 mb-1">Engagement</p>
                        </div>
                        <div className="relative z-10">
                    ...
                    <div className="bg-[#7A553A] text-[#F8F4E1] p-4 md:p-8 rounded-[2rem] md:rounded-[3rem] shadow-xl shadow-[#7A553A]/10 group transition-all relative overflow-hidden flex flex-col justify-between min-h-[150px] md:min-h-0">
                        <div className="relative z-10 flex justify-between items-start">
                            ...
                            <div className="w-7 h-7 md:w-10 md:h-10 bg-white/10 rounded-xl md:rounded-2xl flex items-center justify-center border border-white/10 group-hover:bg-white group-hover:text-[#7A553A] transition-all">
                                <Star className="w-3.5 h-3.5 md:w-5 md:h-5 fill-current" />
                            </div>
                        </div>
                        <div className="relative z-10 flex items-baseline justify-end gap-1 md:gap-2">
                            <p className="text-3xl md:text-5xl font-black italic">{avgRating.toFixed(1)}</p>
                    ...
                    <div className="bg-[#3B2A22]/90 text-white p-4 md:p-8 rounded-[2rem] md:rounded-[3rem] shadow-xl group transition-all relative overflow-hidden flex flex-col justify-between min-h-[150px] md:min-h-0">
                        <div className="relative z-10 flex justify-between items-start">
                            ...
                            <div className="w-7 h-7 md:w-10 md:h-10 bg-white/10 rounded-xl md:rounded-2xl flex items-center justify-center border border-white/10 group-hover:bg-white group-hover:text-[#3B2A22] transition-all">
                                <Bookmark className="w-3.5 h-3.5 md:w-5 md:h-5" />
                            </div>
                        </div>
                        <div className="relative z-10 flex items-baseline justify-end gap-1 md:gap-2">
                    ...
                    <div className="lg:col-span-2 bg-[#C6A982] text-white p-4 md:p-8 rounded-[2rem] md:rounded-[3rem] shadow-xl shadow-[#C6A982]/10 group flex flex-col justify-between relative overflow-hidden min-h-[150px] md:min-h-0">
                        ...
                        <div className="relative z-10 flex items-baseline justify-end gap-2 md:gap-3 mt-auto">
                            <p className="text-3xl md:text-6xl font-black italic">{daftarKarya.length}</p>
                ...
                <div className="grid lg:grid-cols-12 gap-12">
                                ...
                                {daftarKarya.length === 0 ? (
                                    ...
                                    <>
                                            ...
                                            <div key={item.id} className="bg-white/40 dark:bg-brown-dark/40 rounded-[2.5rem] p-5 border border-[#3B2A22]/5 flex gap-4 items-center group/card transition-all hover:bg-white/60">
                                                ...
                                                <div className="w-20 h-28 rounded-[1.2rem] overflow-hidden shrink-0 shadow-lg border-2 border-white/50 relative">
                                                    {item.cover_url ? (
                                                        ...
                                                        <div className="w-full h-full bg-[#E5DDC8]/50 flex items-center justify-center p-3 text-center text-[8px] text-[#3B2A22]/30 font-black uppercase leading-tight">{item.title}</div>
                                                    )}
                                                </div>
                                        ...
                                        <div className="col-span-full flex justify-center gap-2 mt-8">
                                            <div className="w-8 h-2 bg-[#3B2A22] rounded-full"></div>
                                            <div className="w-2 h-2 bg-[#3B2A22]/20 rounded-full"></div>
                                        </div>
                                    </>
                                )}
                            </div>
                    ...
                    <div className="lg:col-span-4 space-y-12">
                        ...
                        <section className="bg-[#3B2A22] rounded-[3rem] p-10 text-white relative overflow-hidden group shadow-2xl shadow-[#3B2A22]/20">
                            <div className="relative z-10">
                                <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center mb-6 border border-white/10 group-hover:rotate-6 transition-transform">
                                    <Sparkles className="w-7 h-7 text-[#F2EAD7]" />
                                </div>
                                <h3 className="text-3xl font-black italic mb-3 leading-tight uppercase">Inspirasi</h3>
                                <p className="text-[11px] text-[#F2EAD7]/60 font-black uppercase tracking-[0.2em] mb-10 leading-relaxed">Setiap kata adalah permata bagi pembaca.</p>
                                <Link href="/admin/editor/tips" className="inline-flex items-center gap-3 bg-[#F2EAD7] text-[#3B2A22] px-8 py-4 rounded-full font-black text-[10px] uppercase tracking-[0.2em] transition-all hover:scale-110 active:scale-95 shadow-xl">
                                    Tips Studio
                                </Link>
                            </div>
