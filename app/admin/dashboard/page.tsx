                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-16">
                    ...
                    <Link href="/admin/stats/engagement" className="lg:row-span-2 bg-[#3B2A22] text-white p-4 md:p-10 rounded-[2rem] md:rounded-[3rem] shadow-2xl dark:shadow-none flex flex-col justify-between group overflow-hidden relative min-h-[150px] md:min-h-[400px] hover:scale-[1.02] transition-all cursor-pointer border border-white/5">
                        <div className="relative z-10">
                            ...
                            <p className="text-[9px] md:text-[12px] font-black uppercase tracking-[0.3em] opacity-60 mb-1">Engagement</p>
                        </div>
                        <div className="relative z-10">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <p className="text-[9px] md:text-[14px] font-bold uppercase tracking-[0.3em] opacity-60">
                                    Views
                                </p>
                            </div>
                        </div>
                    ...
                    <Link href="/admin/stats/kepuasan" className="bg-[#7A553A] text-white p-4 md:p-8 rounded-[2rem] md:rounded-[3.5rem] shadow-xl dark:shadow-none group transition-all relative overflow-hidden flex flex-col justify-between min-h-[150px] md:min-h-0 hover:scale-[1.02] cursor-pointer border border-white/5">
                        <div className="relative z-10 flex justify-between items-start">
                            <p className="text-[9px] md:text-[12px] font-black uppercase tracking-[0.3em] opacity-70">Kepuasan</p>
                            <div className="w-7 h-7 md:w-12 md:h-12 bg-white/10 rounded-xl md:rounded-2xl flex items-center justify-center border border-white/10 group-hover:bg-white group-hover:text-[#7A553A] transition-all">
                    ...
                    <Link href="/admin/stats/disimpan" className="bg-[#433229] text-white p-4 md:p-8 rounded-[2rem] md:rounded-[3.5rem] shadow-xl dark:shadow-none group transition-all relative overflow-hidden flex flex-col justify-between min-h-[150px] md:min-h-0 hover:scale-[1.02] cursor-pointer border border-white/5">
                        <div className="relative z-10 flex justify-between items-start">
                            <p className="text-[9px] md:text-[12px] font-black uppercase tracking-[0.3em] opacity-70">Disimpan</p>
                            <div className="w-7 h-7 md:w-12 md:h-12 bg-white/10 rounded-xl md:rounded-2xl flex items-center justify-center border border-white/10 group-hover:bg-white group-hover:text-[#433229] transition-all">
                    ...
                    <Link href="/admin/stats/karya" className="lg:col-span-2 bg-[#D6BFA6] text-[#3B2A22] p-4 md:p-8 rounded-[2rem] md:rounded-[4.5rem] shadow-xl dark:shadow-none group flex flex-col justify-between relative overflow-hidden min-h-[150px] md:min-h-[220px] hover:scale-[1.01] cursor-pointer transition-all">
                        <div className="relative z-10 flex justify-between items-start">
                            <p className="text-[9px] md:text-[14px] font-black uppercase tracking-[0.4em] opacity-70">Koleksi</p>
                            <div className="w-7 h-7 md:w-14 md:h-14 bg-[#3B2A22]/10 rounded-xl md:rounded-[2rem] flex items-center justify-center border border-[#3B2A22]/10 group-hover:bg-[#3B2A22] group-hover:text-[#D6BFA6] transition-all">
                        ...
                        <div className="relative z-10 flex items-baseline justify-end gap-3 md:gap-4 mt-auto">
                            ...
                            <span className="text-[10px] md:text-[14px] font-black uppercase tracking-[0.3em] opacity-70">Karya</span>
                        </div>
                        {/* Decorative Stripe */}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {daftarKarya.length === 0 ? (
                                    <div className="col-span-full text-center py-32 bg-bg-cream/40 dark:bg-brown-dark/40 rounded-[3rem] border border-dashed border-text-main/10 dark:border-white/10">
                                        ...
                                        <p className="text-text-main/30 dark:text-white/30 font-black uppercase tracking-[0.2em] text-[12px]">Belum ada karya yang terbit</p>
                                    </div>
                                ) : (
                                    <>
                                            ...
                                            <div key={item.id} className="bg-bg-cream/40 dark:bg-brown-dark/40 rounded-[2.5rem] p-5 border border-text-main/5 dark:border-white/5 flex gap-4 items-center group/card transition-all hover:bg-bg-cream/60 dark:hover:bg-brown-dark/60">
                                                ...
                                                <div className="flex-1 py-1 min-w-0">
                                                    <div className="flex flex-wrap items-center gap-2 mb-2">
                                                        ...
                                                        {item.is_completed && (
                                                            <span className="bg-brown-dark text-bg-cream text-[6px] font-black px-2 py-0.5 rounded-full uppercase tracking-widest">TAMAT</span>
                                                        )}
                                                    </div>
                                                    ...
                                                    <div className="flex flex-wrap gap-2 items-center mb-3">
                                                        <div className="flex items-center gap-1 bg-text-main/5 dark:bg-white/5 px-2 py-0.5 rounded-full">
                                                            ...
                                                            <span className="text-[9px] font-black text-text-main/60 dark:text-white/60 uppercase tracking-widest">{item.total_views.toLocaleString()}</span>
                                                        </div>
                                                        <div className="flex items-center gap-1 bg-text-main/5 dark:bg-white/5 px-2 py-0.5 rounded-full">
                                                            <Bookmark className="w-2.5 h-2.5 text-text-main/40 dark:text-white/40" />
                                                            <span className="text-[9px] font-black text-text-main/60 dark:text-white/60 uppercase tracking-widest">{item._count.bookmarks}</span>
                                                        </div>
                                                        <div className="flex items-center gap-1 bg-amber-400/10 px-2 py-0.5 rounded-full">
                                                            ...
                                                            <span className="text-[9px] font-black text-text-main/60 dark:text-white/60 uppercase tracking-widest">{item.avg_rating.toFixed(1)}</span>
                                                        </div>
                                                    </div>

                                                    <div className="flex flex-wrap gap-2 items-center mb-4">
                                                        <div className="bg-text-main/5 dark:bg-white/5 px-3 py-1 rounded-full">
                                                            <span className="text-[8px] font-black text-text-main/60 dark:text-white/60 uppercase tracking-[0.2em]">{item._count.bab} Bab</span>
                                                        </div>
                                                        ...
                                                        <div className="flex items-center justify-between gap-4 mt-2">
                                                            <div className="flex items-center gap-2 flex-1">
                                                                    <Link href={`/admin/editor/karya/${item.id}`} className="bg-text-main dark:bg-brown-mid text-bg-cream px-5 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-brown-mid dark:hover:bg-tan-primary/40 transition-all active:scale-95 group/btn flex-1 text-center">
                                                                        Edit Karya
                                                                    </Link>
                                                                <Link href={`/admin/stats/engagement`} className="bg-text-main/5 dark:bg-white/5 text-text-main dark:text-bg-cream p-2.5 rounded-xl hover:bg-tan-primary/20 transition-all active:scale-95 group/stats border border-text-main/5 dark:border-white/5" title="View Analysis">
                                                                    <BarChart3 className="w-3.5 h-3.5" />
                                                                </Link>
                                                            </div>
                                                            {item.bab[0] && (
                                                                <span className="text-[8px] font-bold text-text-main/30 dark:text-white/30 uppercase tracking-tighter shrink-0">
                    ...
                    <div className="lg:col-span-4 space-y-12">
                        ...
                        <section className="bg-bg-cream/40 dark:bg-brown-dark/40 rounded-[3rem] p-8 border border-text-main/5 dark:border-white/5">
                            ...
                            {latestComments.length === 0 ? (
                                ...
                                <div className="space-y-8">
                                        ...
                                        <div key={c.id} className="group cursor-default">
                                            <div className="flex items-center gap-3 mb-3">
                                                ...
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-[9px] text-text-main/40 dark:text-white/40 font-bold uppercase tracking-widest">{new Date(c.created_at).toLocaleDateString('id-ID')}</span>
                                                </div>
                                            </div>
                                    ...
                                    <Link href="/admin/community" className="w-full text-center py-4 bg-text-main/5 dark:bg-white/5 rounded-[1.5rem] text-[9px] font-black text-text-main dark:text-bg-cream uppercase tracking-[0.2em] hover:bg-text-main/10 dark:hover:bg-white/10 transition-all block mt-8">Manajemen Komentar</Link>
                                </div>
                            )}
                        </section>
                        ...
                        <section className="bg-text-main dark:bg-brown-mid rounded-[3rem] p-10 text-bg-cream relative overflow-hidden group shadow-2xl dark:shadow-none shadow-text-main/20">
                            <div className="relative z-10">
                                ...
                                <Link href="/admin/editor/tips" className="inline-flex items-center gap-3 bg-bg-cream text-text-main px-8 py-4 rounded-full font-black text-[10px] uppercase tracking-[0.2em] transition-all hover:scale-110 active:scale-95 shadow-xl">
                                    Tips Studio
                                </Link>
                            </div>
