export default function Loading() {
    return (
        <div className="min-h-screen bg-[#FDFBF7] dark:bg-slate-950 pb-28 animate-pulse">
            {/* Fake Header */}
            ...
            <nav className="fixed bottom-0 inset-x-0 h-20 bg-white dark:bg-slate-900 border-t border-gray-200 dark:border-slate-800 flex items-center justify-between px-6 z-30 md:max-w-md md:left-1/2 md:-translate-x-1/2 md:rounded-t-3xl md:border-x">
                <div className="w-6 h-6 bg-gray-200 dark:bg-slate-800 rounded"></div>
                <div className="w-12 h-12 bg-gray-200 dark:bg-slate-800 rounded-full -mt-8 border-4 border-[#FDFBF7] dark:border-slate-950"></div>
                <div className="w-6 h-6 bg-gray-200 dark:bg-slate-800 rounded"></div>
            </nav>
        </div>
    );
